...
#[test]
fn sendai() {
    let (lat, lon) = Jgd2000::new(38.26, 140.87).to_jgd2011().into();
...
#[test]
fn iwaki_1() {
    let (lat, lon) = Jgd2000::new(37.090536, 140.840350).to_jgd2011().into();
...
#[test]
fn iwaki_2() {
    let (lat, lon) = Jgd2000::new(37.093698, 140.829111).to_jgd2011().into();
